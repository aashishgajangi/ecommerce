...
export default function ProductCard({ product }: Props) {
  ...
  return (
    <Link href={`/products/${product.slug}`} className="group block rounded-xl overflow-hidden border border-gray-100 hover:border-rose-200 hover:shadow-md transition-all bg-white">
